...
alias smallPoxKill="sudo a2dissite *;sudo service apache2 stop";

alias startWebSystems="sudo service apache2 start;sudo service mysql start;cowsay web started";

alias bigBrother="tail -f /var/log/apache2/error.log";

alias PepperJack="cmatrix -s";
alias crox="cmatrix -s;";
alias train="sl -al";
alias hackers="cat /dev/urandom | hexdump | grep 'ca fe'";
